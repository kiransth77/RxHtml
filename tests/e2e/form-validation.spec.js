...
test.describe('RxHtmx Form Validation Example', () => {
  ...
  test('should validate username field', async ({ page }) => {
    ...
    await usernameInput.blur();
    await expect(usernameValidation).toContainText('Username must be at least 3 characters');
  ...
  test('should validate email field', async ({ page }) => {
    ...
    await expect(emailValidation).toContainText('Please enter a valid email address');
